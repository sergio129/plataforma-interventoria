        ...
        <main style={{ flex: 1 }}>
          <div style={{ backgroundColor: 'white', borderRadius: '12px', padding: '2rem', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
              <h1 style={{ fontSize: '1.875rem', fontWeight: 'bold', color: '#1f2937' }}>Gestión de Documentos</h1>
            ...
            <div style={{ backgroundColor: '#fef2f2', border: '1px solid #fecaca', borderRadius: '8px', padding: '1rem', color: '#dc2626' }}>
              No tienes permisos para acceder a la gestión de documentos. 
      ...
      <main style={{ flex: 1 }}>
        <div style={{ backgroundColor: 'white', borderRadius: '12px', padding: '2rem', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
          ...
          <div style={{ textAlign: 'center', padding: '3rem', color: '#6b7280' }}>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>Módulo de Documentos</h2>
            <p>Aquí podrás gestionar todos los documentos del proyecto de interventoría.</p>
